...
const animais = ["Cachorro", "Gato", "Pássaro", "Peixe", "Roedor"]
...
const schema = yup.object().shape({
    ...
    tipo_pet: yup.string().required('O tipo do pet é obrigatório').oneOf(animais, "Selecione um tipo de pet válido."),
